...
import reactLogo from "/static/images/img.webp";
      ...
      switch (true) {
        case input.trim().length === 0:
          setEmailError(
            <div className="errorMsg">
              <img src="/static/images/x.webp" />
              <p>O campo não pode estar em branco</p>
            </div>
          );
          break;
        case /\s/.test(input):
        ...
        case !/\./.test(input):
          setEmailError(
            <div className="errorMsg">
              <img src="/static/images/x.webp" />
              <p>Precisa conter .com ou semelhantes</p>
            </div>
          );
          break;
        default:
  ...
  function handleSubmit(e) {
    ...
    if (name.trim().length === 0) {
      setNameError(
        <div className="errorMsg">
          <img src="/static/images/x.webp" />
          <p>Preencha o campo novamente</p>
        </div>
      );
    } else {
      submitForm();
  ...
  return (
    <>
      <form>
        ...
        <div>
          <label htmlFor="e-mail" aria-hidden="true" autoComplete="off">
            E-mail
          </label>
          <input
            placeholder="E-mail"
      ...
      <div className={`modal ${isSend ? "visible" : ""}`}>
        <div className="fade-in">
          ...
          <p style={{ color: "#ffffff9a", fontSize: "0.8em" }}>
            (no email will be sent to {text} this is just a test)
          </p>
        </div>
      </div>
    </>
